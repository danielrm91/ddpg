...
if __name__ == '__main__':
    ...
    # run parameters
    parser.add_argument('--env', help='gym env', default='cstrmodel-v0')
    parser.add_argument('--random-seed', help='random seed', default=258)
    parser.add_argument('--max-episodes', help='max num of episodes', default=4)
    parser.add_argument('--max-episode-len', help='max length of each episode', default=600)
